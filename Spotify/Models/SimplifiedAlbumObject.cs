...
namespace Spotify.Models {
    public class SimplifiedAlbumObject : AlbumBase, IParsable 
    {
        ...
        public SimplifiedAlbumObject_album_group? AlbumGroup { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="SimplifiedAlbumObject"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new SimplifiedAlbumObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"album_group", n => { AlbumGroup = n.GetEnumValue<SimplifiedAlbumObject_album_group>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<SimplifiedAlbumObject_album_group>("album_group", AlbumGroup);
