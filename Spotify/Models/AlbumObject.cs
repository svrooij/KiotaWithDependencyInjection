...
namespace Spotify.Models {
    public class AlbumObject : AlbumBase, IParsable 
    {
...
#nullable restore
        ...
        public static new AlbumObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                {"tracks", n => { Tracks = n.GetObjectValue<PagingSimplifiedTrackObject>(PagingSimplifiedTrackObject.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<PagingSimplifiedTrackObject>("tracks", Tracks);
        }
    }
}
