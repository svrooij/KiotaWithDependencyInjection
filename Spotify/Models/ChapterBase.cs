...
namespace Spotify.Models {
    public class ChapterBase : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public ChapterBase_release_date_precision? ReleaseDatePrecision { get; set; }
...
#nullable restore
        ...
        public ChapterBase_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ChapterBase"/> and sets the default values.
        /// </summary>
        public ChapterBase()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ChapterBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ChapterBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ChapterBase();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"release_date_precision", n => { ReleaseDatePrecision = n.GetEnumValue<ChapterBase_release_date_precision>(); } },
                {"restrictions", n => { Restrictions = n.GetObjectValue<ChapterRestrictionObject>(ChapterRestrictionObject.CreateFromDiscriminatorValue); } },
                {"resume_point", n => { ResumePoint = n.GetObjectValue<ResumePointObject>(ResumePointObject.CreateFromDiscriminatorValue); } },
                {"type", n => { Type = n.GetEnumValue<ChapterBase_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ChapterBase_release_date_precision>("release_date_precision", ReleaseDatePrecision);
            writer.WriteObjectValue<ChapterRestrictionObject>("restrictions", Restrictions);
            writer.WriteObjectValue<ResumePointObject>("resume_point", ResumePoint);
            writer.WriteEnumValue<ChapterBase_type>("type", Type);
