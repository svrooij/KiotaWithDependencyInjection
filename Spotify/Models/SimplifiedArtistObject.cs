...
namespace Spotify.Models {
    public class SimplifiedArtistObject : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public SimplifiedArtistObject_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="SimplifiedArtistObject"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="SimplifiedArtistObject"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SimplifiedArtistObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"type", n => { Type = n.GetEnumValue<SimplifiedArtistObject_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<SimplifiedArtistObject_type>("type", Type);
