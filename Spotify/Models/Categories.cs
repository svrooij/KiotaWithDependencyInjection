...
namespace Spotify.Models {
    ...
    /// </summary>
    public class Categories : AlbumBase, IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Categories"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Categories CreateFromDiscriminatorValue(IParseNode parseNode)
        {
