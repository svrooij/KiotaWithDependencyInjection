...
using System;
namespace Spotify.Playlists.Item.Followers.Contains {
    /// <summary>
    ...
    public class ContainsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ContainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/playlists/{playlist_id}/followers/contains?ids={ids}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContainsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/playlists/{playlist_id}/followers/contains?ids={ids}", rawUrl)
        {
        }
        /// <summary>
