...
using System;
namespace Spotify.Me.Albums.Contains {
    /// <summary>
    /// Builds and executes requests for operations under \me\albums\contains
    /// </summary>
    public class ContainsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ContainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/albums/contains?ids={ids}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContainsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/albums/contains?ids={ids}", rawUrl)
        {
        }
        /// <summary>
