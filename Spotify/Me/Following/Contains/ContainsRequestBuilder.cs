...
namespace Spotify.Me.Following.Contains {
    /// <summary>
    /// Builds and executes requests for operations under \me\following\contains
    /// </summary>
    public class ContainsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ContainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/following/contains?ids={ids}&type={type}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContainsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/following/contains?ids={ids}&type={type}", rawUrl)
        {
        }
        /// <summary>
