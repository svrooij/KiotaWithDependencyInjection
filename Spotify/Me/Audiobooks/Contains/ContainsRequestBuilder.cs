...
using System;
namespace Spotify.Me.Audiobooks.Contains {
    /// <summary>
    /// Builds and executes requests for operations under \me\audiobooks\contains
    /// </summary>
    public class ContainsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ContainsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/audiobooks/contains?ids={ids}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContainsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContainsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/audiobooks/contains?ids={ids}", rawUrl)
        {
        }
        /// <summary>
